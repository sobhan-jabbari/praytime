 ...
 */
package ir.afraapps.praytime.phaseEvents;


import ir.afraapps.praytime.posAlgo.Ecliptic;
import ir.afraapps.praytime.posAlgo.LunarPosition;
import ir.afraapps.praytime.posAlgo.SolarPosition;
...
public class MoonPhases {
   ...
   * alarmTime for a given phase (New Moon 0, First Quarter 90, New Crescent 8,
   ...
   * nominal alarmTime for a given phase (New Moon 0, First Quarter 90,
   * etc.)
   */
